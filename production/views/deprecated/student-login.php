...
body,html {font-family: 'Roboto'; background-color: #ddd}
...
.footer p {text-align: center; font-family: 'Roboto' ; font-weight: normal; font-size: 14px; color: #fff; background-color: #036FFC; padding: 5px}
...
#admin-email:focus,#admin-pass:focus {border: 1px solid #036FFC; transition: all  1s}
.login-button {text-transform: uppercase;background-color: #036FFC;padding: 10px; color: #fff; border: 1px solid #036FFC; width: 100%; border-radius: 5px}
