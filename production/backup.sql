...
CREATE TABLE `ass_students` (
  ...
  `by` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `exam` (
  ...
  `exam_name` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `by` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `designation` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `exam_std` (
  ...
  `exam_name` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `by` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `designation` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'Teacher',
  `submitted_by` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `live_class_sir` (
  ...
  `sems` int(10) unsigned NOT NULL,
  `year` int(10) unsigned NOT NULL,
  `class_title` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `by` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `designation` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `links` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `message` (
  ...
  `designation` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'student',
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `by` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `user_info` (
  ...
  `phone` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '00000000000',
  `designation` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'student',
  ...
  `department` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'cse',
  `email` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `gender` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'male',
...
-- Dump completed on 2021-08-09 22:10:41
